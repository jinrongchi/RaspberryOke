...
QT_MOC_LITERAL(3, 15, 5), // "pause"
QT_MOC_LITERAL(4, 21, 4), // "stop"
QT_MOC_LITERAL(5, 26, 8), // "setState"
QT_MOC_LITERAL(6, 35, 19), // "QMediaPlayer::State"
QT_MOC_LITERAL(7, 55, 5), // "state"
QT_MOC_LITERAL(8, 61, 11), // "playClicked"
QT_MOC_LITERAL(9, 73, 13) // "mirrorChecked"

    },
    "Controls\0play\0\0pause\0stop\0setState\0"
    "QMediaPlayer::State\0state\0playClicked\0"
    "mirrorChecked"
};
...
void Controls::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->setState((*reinterpret_cast< QMediaPlayer::State(*)>(_a[1]))); break;
        case 4: _t->playClicked(); break;
        case 5: _t->mirrorChecked(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Controls::play)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Controls::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Controls::pause)) {
                *result = 1;
                return;
            }
        }
